...
#define MP_MUL_TH(a,b,c,d) fmpz_mpoly_mul(a,b,c,d)
            ...
            const fmpz_mpoly_ctx_t ctx)
{
    ...
    {
        MP_MUL_TH(res_num, x_num, y_num, ctx);
        MP_MUL_TH(res_den, x_den, y_den, ctx);
        return;
    }
    ...
    if (fmpz_mpoly_is_one(x_den, ctx))
    {
        ...
        else
        {
            ...
            MP_MUL_TH(res_num, u, y_num, ctx);
            _fmpz_mpoly_q_mpoly_divexact(u, y_den, t, ctx);
            MP_MUL_TH(res_den, x_den, u, ctx);
    ...
    if (fmpz_mpoly_is_one(y_den, ctx))
    {
        ...
        else
        {
            ...
            MP_MUL_TH(res_num, u, x_num, ctx);
            _fmpz_mpoly_q_mpoly_divexact(u, x_den, t, ctx);
            MP_MUL_TH(res_den, y_den, u, ctx);
            fmpz_mpoly_clear(u, ctx);
        }
...

    {
        ...
        if (fmpz_mpoly_is_one(t, ctx))
        {
            ...
            else
            {
                ...
                MP_MUL_TH(res_num, x_num, y, ctx);

                fmpz_mpoly_div(x, x_den, u, ctx);
                MP_MUL_TH(res_den, x, y_den, ctx);
            }
        }
        else
        {
            ...
            if (fmpz_mpoly_is_one(u, ctx))
            {
                ...
                MP_MUL_TH(res_num, x, y_num, ctx);

                fmpz_mpoly_div(y, y_den, t, ctx);
                MP_MUL_TH(res_den, x_den, y, ctx);
            }
            else
            {
                fmpz_mpoly_div(x, x_num, t, ctx);
                fmpz_mpoly_div(y, y_num, u, ctx);
                MP_MUL_TH(res_num, x, y, ctx);

                fmpz_mpoly_div(x, x_den, u, ctx);
                fmpz_mpoly_div(y, y_den, t, ctx);
                MP_MUL_TH(res_den, x, y, ctx);
            }
        }

...
void p_get(const point &p, pc_pair_ptr_vec &terms, unsigned short fixed_database_sector = 0);
void p_get(const point &p, pc_pair_ptr_lst &terms, unsigned short fixed_database_sector = 0);

void p_set(const point &p, pc_pair_ptr_vec &&terms, unsigned char level, unsigned short fixed_database_sector = 0);
inline void p_set(const point &p, pc_pair_vec &&terms, unsigned char level, unsigned short fixed_database_sector = 0) {
...
inline void p_set(const point &p, unsigned int n, pc_pair_ptr_lst::iterator termsB, pc_pair_ptr_lst::iterator termsE, unsigned char level, unsigned short fixed_database_sector) {
...
inline void p_set(const point &p, pc_pair_ptr_lst &terms, unsigned char level, unsigned short fixed_database_sector = 0) {

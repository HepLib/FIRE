...
(*StyleBox[\"upper\", \"TI\"]\)},{\!\(\**)
(*StyleBox[\"lower\", \"TI\"]\)},{\!\(\**)
(*StyleBox[\"dummies\", \"TI\"]\)}] is a type of tensors\n, \!\(\**)
(*StyleBox[\"n\", \"TI\"]\)\**)
(*StyleBox[\(\!\(\**)
(*StyleBox[\" \", \"TI\"]\) \)]is the tensor rank, {\!\(\**)
(*StyleBox[\"upper\", \"TI\"]\)},{\!\(\**)
(*StyleBox[\"lower\", \"TI\"]\)},{\!\(\**)
(*StyleBox[\"dummies\", \"TI\"]\)} are the upper, lower, and contracted indices";*)
...
(* ::Commentary:: *)
(*TypeHierarchy[Number,TComponent[{},{},_List]] is not implemented for patterns, so, manually*)
...
(* ::Subsubsection::GrayLevel[0.900008]::Closed:: *)
(*EuclideanSpace[]*)
...
(* ::Text:: *)
(*Pay attention, that MakeExpresion[RowBox[...]] works only with the lhs___ and rhs___ patterns! I do not really understand the reason.*)
...
sp[a_?VecQ,OrtC[\[Mu]_?VecIndQ]]:=SupIndex[a,\[Mu]]
